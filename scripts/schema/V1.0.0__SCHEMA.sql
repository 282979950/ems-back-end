...
CREATE TABLE `fill_gas_order` (
  ...
  `create_by` int(10) unsigned DEFAULT NULL COMMENT '鍒涘缓鑰?',
  `update_time` datetime DEFAULT NULL COMMENT '鏇存柊鏃堕棿',
  `update_by` int(10) unsigned DEFAULT NULL COMMENT '鏇存柊鑰?',
  `usable` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '鏄惁鍙敤',
  `remarks` varchar(255) DEFAULT NULL COMMENT '澶囨敞',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1000000000 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `repair_order` (
  ...
  `new_safety_code` varchar(64) DEFAULT NULL,
  `old_safety_code` varchar(64) DEFAULT NULL,
...
CREATE TABLE `sys_dictionary` (
  ...
  `dict_category` varchar(50) NOT NULL COMMENT '绫诲埆',
...
CREATE TABLE `user_card` (
  ...
  `card_identifier` varchar(12)  DEFAULT NULL COMMENT 'IC卡识别号',
  `card_password` varchar(6) DEFAULT NULL,
...
CREATE TABLE `user_change` (
  ...
  `user_change_name` varchar(20) DEFAULT NULL COMMENT '用户名称',
  `user_change_phone` varchar(20) DEFAULT NULL COMMENT '用户电话',
  `user_change_idcard` varchar(20) DEFAULT NULL COMMENT '用户身份证号码',
  `user_change_deed` varchar(20) DEFAULT NULL COMMENT '用户房产证号码',
  `user_old_name` varchar(20) DEFAULT NULL COMMENT '旧用户名称',
  `user_old_phone` varchar(20) DEFAULT NULL COMMENT '旧用户电话',
  `user_old_idcard` varchar(20) DEFAULT NULL COMMENT '旧用户身份证号码',
  `user_old_deed` varchar(20) DEFAULT NULL COMMENT '旧用户房产证号码',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `wx_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `wx_user_id` varchar(30) NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
