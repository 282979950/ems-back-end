...
public class BusinessReportQueryController {
    ...
    @ResponseBody
    public JsonData ReportBusinessDataQueryList(UserOrders orders,Integer pageNum, Integer pageSize){
    ...
    @ResponseBody
    public JsonData ReportBusinessDataQuerySearchList(UserOrders orders,Integer pageNum, Integer pageSize){
        return orderService.ReportBusinessDataQueryService(orders,pageNum,pageSize);
    }
}
