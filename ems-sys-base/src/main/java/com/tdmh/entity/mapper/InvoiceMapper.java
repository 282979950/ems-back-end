...
public interface InvoiceMapper {
    List<Invoice> getAllAssignInvoiceList(@Param("invoiceCode") String invoiceCode, @Param("invoiceNumber") String invoiceNumber,
                                          @Param("currentEmpId") Integer currentEmpId);
    ...
    int updateInvoiceToEmployee(@Param("invoiceCode") String invoiceCode, @Param("invoiceNumberList") List<String> invoiceNumberList,
                                @Param("empId") Integer empId, @Param("currentEmpId") Integer currentEmpId);
