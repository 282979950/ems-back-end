 ...
 * Http与Servlet工具类.
 *
 * @author calvin/thinkgem on 2016-8-19.
 */
...
//        Principal principal = UserUtils.getPrincipal();
        ...
        return (accept != null && accept.contains("application/json")) || (xRequestedWith != null && xRequestedWith.contains("XMLHttpRequest")) || principal
                != null || userAgent.contains("okhttp");
    }
