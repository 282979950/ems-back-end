...
CREATE TABLE `user_orders` (
  ...
  `order_status` int(4) unsigned DEFAULT NULL COMMENT '订单状态',
  `order_supplement` decimal(10,2)  NOT NULL DEFAULT '0.00' COMMENT '应补金额',
  `account_type` int(4) unsigned DEFAULT NULL COMMENT '账务状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` int(10) unsigned DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `update_by` int(10) unsigned DEFAULT NULL COMMENT '更新者',
...
`user_id`  int(10) unsigned NULL DEFAULT NULL COMMENT '锁定用户Id' ,
...
CREATE TABLE `user_card` (
  `user_card_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户IC卡编号',
  ...
  `card_initialization` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否初始化',
...
`gas_price_id`  int(2) NOT NULL AUTO_INCREMENT COMMENT '气价编号',
`user_type`  int(4) NULL DEFAULT NULL COMMENT '用户类型',
`user_gas_type`  int(4) NULL DEFAULT NULL COMMENT '用气类型',
`gas_range_one`  decimal(10,2) NULL DEFAULT NULL COMMENT '第一阶梯起始范围',
`gas_price_one`  decimal(10,2) NULL DEFAULT NULL COMMENT '第一阶梯气价',
`gas_range_two`  decimal(10,2) NULL DEFAULT NULL COMMENT '第二阶梯起始范围',
`gas_price_two`  decimal(10,2) NULL DEFAULT NULL COMMENT '第二阶梯气价',
`gas_range_three`  decimal(10,2) NULL DEFAULT NULL COMMENT '第三阶梯起始范围',
`gas_price_three`  decimal(10,2) NULL DEFAULT NULL COMMENT '第三阶梯气价',
`gas_range_four`  decimal(10,2) NULL DEFAULT NULL COMMENT '第四阶梯起始范围',
`gas_price_four`  decimal(10,2) NULL DEFAULT NULL COMMENT '第四阶梯气价',
`create_time` datetime DEFAULT NULL COMMENT '创建时间',
`create_by` int(10) unsigned DEFAULT NULL COMMENT '创建者',
`update_time` datetime DEFAULT NULL COMMENT '更新时间',
`update_by` int(10) unsigned DEFAULT NULL COMMENT '更新者',
